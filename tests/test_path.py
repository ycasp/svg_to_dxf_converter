...
class TestPath(unittest.TestCase):
    def setUp(self):
        ...
        element_complicated_path = {
            'd': "M 50,250 L 150,50 C 200,150 300,150 350,50 Q 400,0 450,50 A 80, 40 60 0 1 400,150 "
    ...
    def test_draw_elliptic_arc(self):
        ...
        self.msp_mock.add_ellipse.assert_called_once_with(center=center, major_axis=(83.35900, -86.32078), ratio=0.75,
                                                          start_param=-0.9173034751259864,
                                                          end_param=-2.1777507399891425)
        self.msp_mock.reset_mock()
        ...
        self.msp_mock.add_ellipse.assert_called_once_with(center=center, major_axis=(-130.32514, -63.56382),
                                                          ratio=0.5379310344827586,
